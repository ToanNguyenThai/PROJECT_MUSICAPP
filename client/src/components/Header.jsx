import React, { useState, setIsMenu } from 'react'
...
//goi mot ham callback tai classname cua navlink, trong ham callback su dung isActive cua ReactRouter, xet mot if. 